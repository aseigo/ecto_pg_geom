defmodule EctoPgGeom.Circle do
  ...
  May be used as a field in an `Ecto.Schema` for automatic use of circle data stored in the database:

      field :circle, EctoPgGeom.Circle

  Assigning to a circle field can be done either by manually creating a `%Postgrex.Circle{}` struct, or by
